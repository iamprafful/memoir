package com.memoir.api.controller;

import com.memoir.api.model.User;
import com.memoir.api.repository.UserRepository;
import com.memoir.api.service.JwtUserDetailsService;
import com.memoir.api.util.JwtTokenUtil;
import com.memoir.api.util.MemoirUtil;
...
public class UserController {
    ...
    final MemoirUtil memoirUtil;
    final UserRepository userRepository;
    final AuthenticationManager authenticationManager;
    final JwtUserDetailsService userDetailsService;
    final JwtTokenUtil jwtTokenUtil;

    public UserController(MemoirUtil memoirUtil, UserRepository userRepository,
                          AuthenticationManager authenticationManager, JwtUserDetailsService userDetailsService,
                          JwtTokenUtil jwtTokenUtil) {
        this.memoirUtil = memoirUtil;
